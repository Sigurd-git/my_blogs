# This is a note showing how to install Ubuntu 22.04 LTS Server on Raspberry Pi 3B.

## 1. Download the image 下载镜像

Download the image from [here](https://ubuntu.com/download/raspberry-pi/thank-you?version=22.04.2&architecture=server-arm64+raspi).
...
sudo dd if=ubuntu-22.04.2-preinstalled-server-arm64+raspi.img of=/dev/rdisk4 bs=8m status=progress
